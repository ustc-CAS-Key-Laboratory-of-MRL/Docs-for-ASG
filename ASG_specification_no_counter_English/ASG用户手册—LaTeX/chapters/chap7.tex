...
\noindent {\textcircled{\normalsize{\textbf{1}}}}. The working environment of the ASG-GT50-C must be between 0  $^{\circ}$C  to + 50  $^{\circ}$C.
%\noindent {\textcircled{\normalsize{\textbf{1}}}}. 任意序列发生器的外界工作环境温度必须在-10 $^{\circ}$C 至 +50 $^{\circ}$C以内。

\noindent {\textcircled{\normalsize{\textbf{2}}}}. Do not place any heavy object on the top of the case.
